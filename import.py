...
def main():
    ...
    db.execute("CREATE TABLE comments (id SERIAL PRIMARY KEY, name VARCHAR NOT NULL, comment VARCHAR NOT NULL, blog_id INTEGER NOT NULL REFERENCES blog(blog_id) ON DELETE CASCADE)")
